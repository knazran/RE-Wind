...
init -1 python hide:
    ...
    config.main_menu_music = "music/Rumination.ogg"
    ...
    config.end_game_transition = Fade(0.1, 0.0, 0.5, color="#fff")
...
python early:
    config.save_directory = "Save The Girl-1401024254"
...
init python:
    ...
    build.directory_name = "Save The Girl-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Save The Girl"
